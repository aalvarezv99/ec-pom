...
AS $function$
  ...
  -- Fecha: 05/Abril/2022 Version 1.4 ThainerPerez
  -- Se Actualiza la forma en que se calcula el saldo al dia, ya no consultando la tabla ahora usando la funcion
  -- ============================================================================
 ...
 with creditos as (select distinct c.id id
 							from credito c 
...
select ceiling(sum(calcular_saldo_al_dia(creditos.id,v_fecha::date::text))) into saldoAlDia from creditos;
