...
Característica: Originacion de Creditos
  ...
  Esquema del escenario: Analisis del credito
    ...
    Entonces Valida los valores del simulador<Mes><Monto><Tasa><Plazo><Ingresos><descLey><descNomina><colchon><vlrCompasSaneamientos>
  ...
  Esquema del escenario: Clientes para Bienvenida
    ...
    Y se marcar los check corretos junto con el celular y correo<Celular><Correo>
