...
Característica: Originacion Compra Cartera
  ...
  Esquema del escenario: Simulador Asesor
    ...
    Ejemplos: 
      ...
      | "ALCALDIA MUNICIPAL DE MANIZALES NÓMINA JUBILADOS" | "79524937" | "06/May/1972" | "Bogotá Centro" | "Pensionado" | "1.6" | "18" | "25000000" | "25"                 | "4500000" | "360000" | "50000"    | "2000000"             | "4500000"   | "20500000"   | "0"                   | "xx" | "0"     | "Pensionado por Tiempo (Vejez)" | "10/03/2000" | "GERMAN"  | "ARTURO"  | "DUCUARA" | "german79524937@mail.com" | "3130002586" | "Bogotá D.C" | "Bogota" | "src/test/resources/Data/PDFPRUEBA.pdf" | "2021-04-20"  | "Educacion propia" | "F"  | "Soltero"   | "79524937" | "06/May/1972" | "Calle 2d #22-52" | "FAMILIAR"   | "GERMAN"        | "VICTORIA"          | "DONCEL"             | "7510273"          | "9807146"       | "3112" | "Agosto" | "Efectivo" | "03/05/2021" | "Remanentes - 60237038927 - REMANENTE" |
  ...
  Esquema del escenario: Solicitar credito con compra de cartera
    ...
    Ejemplos: 
      ...
      | "ALCALDIA MUNICIPAL DE MANIZALES NÓMINA JUBILADOS" | "79524937" | "06/May/1972" | "Bogotá Centro" | "Pensionado" | "1.6" | "18"  | "25000000" | "25"                 | "4500000" | "360000" | "50000"    | "4500000"   | "20500000"   | "2000000"             | "xx" | "0"     | "Pensionado por Tiempo (Vejez)" | "10/03/2000" | "GERMAN"  | "ARTURO"  | "DUCUARA" | "german79524937@mail.com" | "3130002586" | "Bogotá D.C" | "Bogota" | "src/test/resources/Data/PDFPRUEBA.pdf" | "2021-04-20"  | "Educacion propia" | "F"  | "Soltero"   | "79524937" | "06/May/1972" | "Calle 2d #22-52" | "FAMILIAR"   | "GERMAN"        | "VICTORIA"          | "DONCEL"             | "7510273"          | "9807146"       | "3112" | "Agosto" | "Efectivo" | "03/05/2021" | "Remanentes - 60237038927 - REMANENTE" | "8300538122 -  FIDEICOMISO SOLUCIONES" | "2000000" | "100000"  | "31/07/21"        | "1223"         |
  ...
  Esquema del escenario: Analisis del credito con compra de cartera
    ...
    Ejemplos: 
      ...
      | "ALCALDIA MUNICIPAL DE MANIZALES NÓMINA JUBILADOS" | "79524937" | "1.6" | "18"  | "25000000"   | "25"                 | "4500000" | "360000" | "50000"    | "4500000"   | "20500000"   | "2000000"              | "GERMAN"      |"Octubre"|"2021"|
  ...
  Esquema del escenario: Creditos para Visacion
    ...
    Ejemplos: 
      ...
      | "79524937" | "24/08/2021" 			 | "src/test/resources/Data/PDFPRUEBA.pdf"  |
  ...
  Esquema del escenario: Visacion de la cartera
    ...
    Ejemplos: 
    | Cedula     |rutaPDF         |
    | "79524937" |  "src/test/resources/Data/PDFPRUEBA.pdf"  |
  ...
  Esquema del escenario: Carteras para Desembolso
    ...
    Ejemplos: 
     ...
     | "79524937" | "25000000"    |  "200000"                  | "src/test/resources/Data/PDFPRUEBA.pdf" |"Remanentes - 60237038927 - REMANENTE"     |
  ...
  Esquema del escenario: Remanente para Desembolso
    ...
    Ejemplos: 
     ...
     | "79524937" | "25000000" | "2000000" 							| "Remanentes - 60237038927 - REMANENTE" | "src/test/resources/Data/PDFPRUEBA.pdf" |
