...
Característica: Retanqueo de creditos
 ...
 Esquema del escenario:  Retanqueo libre inversion
  ...
  Ejemplos: 
    ...
    |"3000000"|"80226849"|"53045"   |"C:\\Users\\User\\Documents\\PDFPRUEBA.pdf"|"1.8"|"60" |"10"                |"8500000"|"280000" | "50000"    | "3500000"   |"2258"|"8600068225 - ACORE"    | "650000"   | "50000"      | "26/07/2021"        | "9123"          | "8110315267 - AMAR"    | "450000"       | "40000"      | "30/07/2021"        | "9321"          |
  ...
  Esquema del escenario: Analisis del credito
    ...
    Entonces Valida los valores del simulador retanqueos con compra de cartera y saneamiento <Retanqueo><fecha><Mes><Plazo><Ingresos><descLey><descNomina><Cartera1><Saneamiento2>
    Y Guarda los datos del simulador
    Y Pasa a la pestana endeudamiento global aprobando
    Y Aprueba la tarea del credito<Cedula>
   Ejemplos: 
    |Retanqueo|Cedula         |NombreCredito |Ingresos |decLey    |descNomina|Mes    |Tasa  |Plazo|descLey  |descNomina|fecha       |Cartera1|Saneamiento2|
    |"3000000"|"80226849"     |"JAIVER"      |"8500000"|"280000"  |"50000"   |"Julio"|"1.8" |"60" |"280000" |"50000"   |"16/07/2021"|"650000"|"450000"    |
   ...
   Esquema del escenario: Clientes para Bienvenida
    ...
    |"80226849"  |"650000"|"Remanentes - 60237038927 - REMANENTE" |"C:\\Users\\User\\Documents\\PDFPRUEBA.pdf"|
    ...
    Ejemplos: 
    |Cedula      |rutaPDF                                    |
    |"80226849"  |"C:\\Users\\User\\Documents\\PDFPRUEBA.pdf"|
    ...
    |"80226849"  |"450000"    |"Remanentes - 60237038927 - REMANENTE" |"C:\\Users\\User\\Documents\\PDFPRUEBA.pdf"|
