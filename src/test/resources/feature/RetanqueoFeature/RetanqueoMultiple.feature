...
Característica: Retanqueo de creditos
 ...
 Esquema del escenario:  Retanqueo libre inversion
  ...
  Ejemplos: 
  |Retanqueo  |Cedula    |Credito |Pagaduria           |rutaPDF 	                                    |Tasa |Plazo|DiasHabilesIntereses|Ingresos |descLey | descNomina|VlrCompraSaneamiento|codigo|    
  |"12000000"|"8682110" |"71403" |"P.A COLPENSIONES"   |"src/test/resources/Data/PDFPRUEBA.pdf"		    |"1.8"|"90" |"10"                |"6500000"|"380000" |"100000"  |"3500000"           |"2258"|
